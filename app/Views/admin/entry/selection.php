...
<div class="flex-1 overflow-y-auto p-8 flex flex-col items-center justify-center">
    ...
    <div class="grid md:grid-cols-2 gap-8 max-w-5xl w-full mt-8">
        ...
        <!--
        <a href="<?= base_url('admin/entry/rutin') ?>" class="group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl hover:border-teal-500/50 dark:hover:border-teal-500/50 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors duration-300 shadow-xl dark:shadow-2xl">
            ...
            <h3 class="text-xl font-bold text-slate-800 dark:text-white mb-3 transition-colors">Input Realisasi Rutin</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 leading-relaxed transition-colors">Gunakan untuk menginput capaian IKU bulanan yang belum terisi sama sekali. Data akan langsung diperbarui ke dashboard utama.</p>
        </a>
        -->
