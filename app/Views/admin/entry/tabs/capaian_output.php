...
<!-- FORM INPUT MANUAL -->
<form id="formCapaianOutputEntry" class="bg-white/50 dark:bg-slate-900/50 rounded-xl p-6 border border-slate-200 dark:border-slate-700/50 transition-colors duration-300">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <!-- TAHUN -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Tahun</label>
            <select id="thn_capaian_output" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white font-bold focus:outline-none focus:border-teal-500 transition-colors">
        ...
        <div>
            ...
            <select id="bulan" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white font-bold focus:outline-none focus:border-teal-500 transition-colors">
                <?php 
        ...
        <div>
            ...
            <select id="no_bulan" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white font-bold focus:outline-none focus:border-teal-500 transition-colors">
                <?php for($i = 1; $i <= 12; $i++): ?>
        ...
        <div class="md:col-span-4">
            ...
            <select id="select_master_ro_output" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors">
        ...
        <div class="md:col-span-2">
            ...
            <input type="text" id="rincian_output" readonly class="w-full bg-slate-100 border border-slate-300 dark:bg-slate-800 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-500 dark:text-slate-300 cursor-not-allowed focus:outline-none transition-colors" placeholder="Auto">
        </div>

        <!-- KODE RO (Auto-fill, readonly) -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">RO</label>
            <input type="text" id="kode_ro" readonly class="w-full bg-slate-100 border border-slate-300 dark:bg-slate-800 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-500 dark:text-slate-300 cursor-not-allowed focus:outline-none transition-colors" placeholder="Auto">
        </div>

        <!-- NO RO (Auto-fill, readonly) -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">No. RO</label>
            <input type="number" id="no_ro_capaian" readonly class="w-full bg-slate-100 border border-slate-300 dark:bg-slate-800 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-500 dark:text-slate-300 cursor-not-allowed focus:outline-none transition-colors" placeholder="Auto">
        </div>

        <!-- TARGET % BULAN -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Target % Bulan</label>
            <input type="number" step="0.01" id="target_persen_bulan" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- REALISASI -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Realisasi</label>
            <input type="number" step="0.01" id="realisasi_capaian" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- % REALISASI -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">% Realisasi</label>
            <input type="number" step="0.01" id="persen_realisasi" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- REALISASI KUMULATIF -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Realisasi Kumulatif</label>
            <input type="number" step="0.01" id="realisasi_kumulatif" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- % REALISASI KUMULATIF -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">salah % Realisasi Kumulatif</label>
            <input type="number" step="0.01" id="salah_persen_realisasi_kumulatif" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- CAPAIAN -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Capaian</label>
            <input type="number" step="0.01" id="capaian" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- KATEGORI -->
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Kategori</label>
            <select id="kategori" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white font-bold focus:outline-none focus:border-teal-500 transition-colors">
        ...
        <div>
            ...
            <input type="number" step="0.01" id="target_tahun" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>

        <!-- KATEGORI BELANJA -->
        <div class="md:col-span-2">
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Kategori Belanja</label>
            <select id="kategori_belanja" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white font-bold focus:outline-none focus:border-teal-500 transition-colors">
        ...
        <div>
            <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Realisasi Kumulatif %</label>
            <input type="number" step="0.01" id="realisasi_kumulatif_persen" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors" placeholder="0.00">
        </div>
    </div>
