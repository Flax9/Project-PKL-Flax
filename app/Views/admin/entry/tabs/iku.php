...
<form id="formIku" class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <select name="tahun" id="tahun" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors">
        ...
        <div>
            ...
            <select name="bulan" id="bulan" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors">
        ...
        <div>
            ...
            <select name="fungsi" id="fungsi" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="md:col-span-1">
            ...
            <select name="no_iku" id="no_iku" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors">
        ...
        <div class="md:col-span-3">
            ...
            <select name="no_indikator" id="no_indikator"
                class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 transition-colors"
                required>
    ...
    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <div class="col-span-2">
            ...
            <select name="kat_bulan" id="kat_bulan" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="kat_tahun" id="kat_tahun" class="w-full bg-slate-50 border border-slate-300 dark:bg-slate-900 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-800 dark:text-white focus:outline-none focus:border-teal-500 transition-colors">
                <option value="Sangat Baik">Sangat Baik</option>
                <option value="Baik">Baik</option>
                <option value="Cukup">Cukup</option>
            </select>
...
<div id="modalEdit" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/80 backdrop-blur-sm p-4">
    <div class="bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl w-full max-w-2xl shadow-2xl transform transition-all">
        <div class="p-6 border-b border-slate-300 dark:border-slate-700 flex justify-between items-center bg-slate-100 dark:bg-slate-800/50 rounded-t-2xl transition-colors">
            <h3 class="text-lg font-bold text-slate-800 dark:text-white transition-colors">
                <i class="fa-solid fa-pen-to-square text-amber-500 mr-2"></i> Edit Data
            </h3>
            <button id="btnCloseModal" class="text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white transition-colors">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-300 dark:border-slate-700/50 transition-colors">
                <div class="col-span-2">
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Fungsi</label>
                    <select id="edit_fungsi" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <!-- Opsi akan dicopy dari main form via JS -->
                    </select>
                </div>
                <div>
                     <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Tahun</label>
                     <select id="edit_tahun" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <option value="2025">2025</option>
                        <option value="2026">2026</option>
                     </select>
                </div>
                <div>
                     ...
                     <select id="edit_bulan" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <!-- Opsi akan dicopy dari main form via JS -->
                     </select>
                </div>
                 <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">No. IKU</label>
                    <select id="edit_no_iku" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <!-- Opsi akan dicopy dari main form via JS -->
                    </select>
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Indikator</label>
                    <select id="edit_no_indikator" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                         <!-- Opsi akan dicopy dari main form via JS -->
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Target</label>
                    <input type="number" step="0.01" id="edit_target" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Realisasi</label>
                    <input type="number" step="0.01" id="edit_realisasi" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Perf % Bulan</label>
                    <input type="number" step="0.01" id="edit_perf_bulan" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Kat Bulan</label>
                    <select id="edit_kat_bulan" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <option value="Sangat Baik">Sangat Baik</option>
                        <option value="Baik">Baik</option>
                        <option value="Cukup">Cukup</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="edit_perf_tahun" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Kat Tahun</label>
                    <select id="edit_kat_tahun" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                        <option value="Sangat Baik">Sangat Baik</option>
                        <option value="Baik">Baik</option>
                        <option value="Cukup">Cukup</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="edit_norm_persen" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
                <div>
                    <label class="block text-[10px] font-bold text-slate-500 uppercase mb-2">Norm Angka</label>
                    <input type="number" step="0.01" id="edit_norm_angka" class="w-full bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2 text-slate-800 dark:text-white focus:border-amber-500 focus:outline-none transition-colors">
                </div>
            </div>
        </div>

        <div class="p-6 border-t border-slate-300 dark:border-slate-700 flex justify-end gap-3 bg-slate-100 dark:bg-slate-800/50 rounded-b-2xl transition-colors">
