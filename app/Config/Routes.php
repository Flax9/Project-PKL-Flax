...
$routes->group('admin', function($routes) {
    ...
    /** * ALUR VERIFIKASI (GATEWAY) - PUBLIC ROUTES
    ...
    $routes->group('', ['filter' => 'auth'], function($routes) {
        ...
        $routes->get('entry/get_iku_by_tahun/(:segment)', 'Admin\Entry::get_iku_by_tahun/$1');
        $routes->get('entry/get_all_no_iku', 'Admin\Entry::get_all_no_iku');
        ...
        $routes->get('pengajuan/check_data', 'Admin\Pengajuan::check_data');
        ...
        // fallback route untuk method lain di Entry (Ditaruh di paling belakang dari filter auth)
